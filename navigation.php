...
<!--内容部分-->
<div class="main">
    <div class="head"><?php echo "{$type}导航页"; ?></div>
    <div class="marquee">
    <marquee>
    ...
    <div class="body">
        <div class="top">
            <h3>标签</h3>
            <div class="tags">
                <a href="navigation_novel_tag_1_0.html" class="tag_free">恋爱</a>
